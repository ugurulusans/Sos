...
class SoSearchpro extends \Opencart\System\Engine\Controller {	
	...
	public function index( $setting ) { 
		...
		if (!class_exists('Cache_Lite'))
			require_once (DIR_EXTENSION . 'so_entry/system/library/so/searchpro/Cache_Lite/Lite.php');
		...
		if ($use_cache){
			...
			if (!$_data) {
				...
				$_data = $this->load->view('extension/so_entry/module/so_searchpro/'.$data['store_layout'], $data);
			...
			$data = $this->readData($setting);
			return $this->load->view('extension/so_entry/module/so_searchpro/'.$data['store_layout'], $data);
		}
	...
	public function readData($setting) {
		...
		static $module = 0;
		$this->load->language('extension/so_entry/module/so_searchpro','',$this->config->get('config_language'));
	...
	public function getProducts($setting)
	{
		...
		$this->load->language('extension/module/so_searchpro','',$this->config->get('config_language'));
		
		$products_arr = $this->model_extension_so_entry_module_so_searchpro->getProducts($filter_data);
	...
	public function autocomplete() {
		...
		$this->load->language('product/category','',$this->config->get('config_language'));
