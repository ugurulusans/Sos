...
class SoTools extends \Opencart\System\Engine\Controller {	
	...
	public function index($setting) {
		...
		static $module = 0;
		$this->load->language('extension/so_entry/module/so_tools','',$this->config->get('config_language'));
		...
		$this->document->addStyle('extension/so_entry/catalog/view/javascript/so_tools/css/style.css');		
		$data['tool_js'] = 'extension/so_entry/catalog/view/javascript/so_tools/js/script.js';

		// Currency
		$this->load->language('common/currency','',$this->config->get('config_language'));
		...
		// Language
		$this->load->language('common/language','',$this->config->get('config_language'));
		...
		return $this->load->view('extension/so_entry/module/so_tools/layout', $data);
	}
	...
	public function infocart() {
		...
		return $this->load->view('extension/so_entry/module/so_tools/infocart', $data);
	}
}