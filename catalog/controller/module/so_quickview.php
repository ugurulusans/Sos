...
class SoQuickview extends \Opencart\System\Engine\Controller {
	...
	public function index($setting) {
		...
		$this->load->language('extension/so_entry/module/so_quickview','',$this->config->get('config_language'));
		...
		$this->document->addStyle('extension/so_entry/catalog/view/javascript/so_quickview/css/quickview.css');
		
		if (!defined ('magnific_popup')){
			$this->document->addStyle('extension/so_entry/catalog/view/javascript/so_quickview/css/lib.css');
			$this->document->addScript('extension/so_entry/catalog/view/javascript/so_quickview/js/jquery.magnific-popup.min.js');
		...
		return $this->load->view('extension/so_entry/module/so_quickview/default', $data);
	}

	public function detail() {
		
		$this->load->language('product/product','',$this->config->get('config_language'));
		$this->load->model('catalog/category');
		...
		if ($product_info) {
			...
			$this->document->addScript('extension/so_entry/catalog/view/javascript/jquery/magnific/jquery.magnific-popup.min.js');
			$this->document->addStyle('extension/so_entry/catalog/view/javascript/jquery/magnific/magnific-popup.css');
			
			$this->document->addScript('extension/so_entry/catalog/view/javascript/bootstrap/js/bootstrap.min.js');
			$this->document->addScript('extension/so_entry/catalog/view/javascript/jquery/datetimepicker/moment.min.js');
			$this->document->addScript('extension/so_entry/catalog/view/javascript/jquery/datetimepicker/moment-with-locales.min.js');			
			$this->document->addScript('extension/so_entry/catalog/view/javascript/jquery/datetimepicker/daterangepicker.js');
			$this->document->addStyle('extension/so_entry/catalog/view/javascript/jquery/datetimepicker/daterangepicker.css');

			
			$this->document->addStyle('extension/so_entry/catalog/view/stylesheet/bootstrap.css');
			...
			$this->response->setOutput($this->load->view('extension/so_entry/module/so_quickview/product', $data));
		} else {
			$url = '';
