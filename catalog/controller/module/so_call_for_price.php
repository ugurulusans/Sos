...
class SoCallForPrice extends \Opencart\System\Engine\Controller {	
	public function index() {
		...
		$this->response->setOutput($this->load->view('extension/so_entry/module/so_call_for_price/form', $data));
	}
    ...
    function sendData() {
        ...
        if (isset($_POST['isAjax']) && $_POST['isAjax'] == 1 && isset($_POST['product_id'])) {
            ...
            if (!isset($json['errors'])) {
                ...
                $sent = $this->model_extension_so_entry_module_so_call_for_price->sendData($data);
                if ($sent) {
                    $json['status'] = 1;
