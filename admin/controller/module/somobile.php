...
require_once (DIR_EXTENSION.'so_entry/admin/view/template/soconfig/class/so_fieldMobile.php');
...
class SoMobile extends \Opencart\System\Engine\Controller {
    ...
    public function index() {
		/*===== Load language ========== */
		$this->load->language('extension/so_entry/module/somobile','',isset($this->request->cookie['language'])?$this->request->cookie['language']:$this->config->get('config_language'));
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			$this->model_extension_so_entry_module_soconfig_setting->editMobile( $this->request->post,$store_id);	
			...
			if($this->request->post['buttonForm'] == 'color' ){
				...
				if(!$data['scsscompile']){
					...
					$this->response->redirect($this->url->link('extension/so_entry/module/somobile', 'user_token=' . $this->session->data['user_token'], 'SSL'));
				}else{
				...
				$this->response->redirect($this->url->link('extension/so_entry/module/somobile', 'user_token=' . $this->session->data['user_token'] . '&store_id=' . $store_id, true));
			} else {
		...
		if (($this->request->server['REQUEST_METHOD'] != 'POST') || $this->request->server['REQUEST_METHOD'] == 'POST' && $this->validate() ) {
			$module_info = $this->model_extension_so_entry_module_soconfig_setting->getMobile($store_id);
		...
		// ---------------------------Load module --------------------------------------------
		/*$data['clear_cache_href'] = $this->url->link('extension/so_entry/module/soconfig/clearcache', 'user_token=' . $this->session->data['user_token'].'&store_id='.$store_id, 'SSL');
		$data['clear_css_href'] = $this->url->link('extension/so_entry/module/soconfig/clearcss', 'user_token=' . $this->session->data['user_token'].'&store_id='.$store_id, 'SSL');
		$data['compiled_css'] = $this->url->link('extension/so_entry/module/soconfig/compiled_css', 'user_token=' . $this->session->data['user_token'].'&store_id='.$store_id, 'SSL');
		*/
		...
		$data['base_href'] = $this->url->link('extension/so_entry/module/somobile', 'user_token=' . $this->session->data['user_token'].'&store_id='.$store_id, 'SSL');
		$data['action'] = $this->url->link('extension/so_entry/module/somobile', 'user_token=' . $this->session->data['user_token'] . '&store_id=' . $store_id, true);
		...
		$data['fields'] = $fields;
		$this->response->setOutput($this->load->view('extension/so_entry/soconfig/somobile', $data));
	}
    ...
    public function install(){
		...
		//$main_sql = DIR_EXTENSION.'so_entry/admin/view/template/soconfig/demo/mobile/install.php';
	...
	private function setupEvent() {
		...
		$this->removeEvent();
		$this->load->model('extension/so_entry/module/soconfig/setting');
		$this->model_extension_so_entry_module_soconfig_setting->addEvent('so_somobile','', "catalog/view/common/home/before", "extension/so_entry/event/so_somobile.so_entry_home_before" , 1 , 1);
		
		$this->model_extension_so_entry_module_soconfig_setting->addEvent('so_somobile','', "catalog/view/common/header/before", "extension/so_entry/event/so_somobile.so_entry_header_before" , 1 , 1);
		
		$this->model_extension_so_entry_module_soconfig_setting->addEvent('so_somobile','', "catalog/view/common/search/before", "extension/so_entry/event/so_somobile.so_entry_search_before" , 1 , 1);
		
		$this->model_extension_so_entry_module_soconfig_setting->addEvent('so_somobile','', "catalog/view/common/language/before", "extension/so_entry/event/so_somobile.so_entry_language_before" , 1 , 1);
		
		$this->model_extension_so_entry_module_soconfig_setting->addEvent('so_somobile','', "catalog/view/common/currency/before", "extension/so_entry/event/so_somobile.so_entry_currency_before" , 1 , 1);
		
		$this->model_extension_so_entry_module_soconfig_setting->addEvent('so_somobile','', "catalog/view/common/footer/before", "extension/so_entry/event/so_somobile.so_entry_footer_before" , 1 , 1);
		
		$this->model_extension_so_entry_module_soconfig_setting->addEvent('so_somobile','', "catalog/view/product/product/before", "extension/so_entry/event/so_somobile.so_entry_product_before" , 1 , 1);
		
		$this->model_extension_so_entry_module_soconfig_setting->addEvent('so_somobile','', "catalog/view/product/category/before", "extension/so_entry/event/so_somobile.so_entry_category_before" , 1 , 1);		
    ...
    protected function validate() {
		if (!$this->user->hasPermission('modify', 'extension/so_entry/module/somobile')) {
