...
class Quickview extends \Opencart\System\Engine\Controller {
	...
	public function index() {
		...
		if ($product_info) {
        	...
        	$this->load->language('extension/so_entry/soconfig','',$this->config->get('config_language'));
			...
			$this->document->addScript('extension/so_entry/catalog/view/javascript/jquery/datetimepicker/moment/moment.min.js');
			$this->document->addScript('extension/so_entry/catalog/view/javascript/jquery/datetimepicker/moment/moment-with-locales.min.js');
			$this->document->addScript('extension/so_entry/catalog/view/javascript/jquery/datetimepicker/bootstrap-datetimepicker.min.js');
			$this->document->addStyle('extension/so_entry/catalog/view/javascript/jquery/datetimepicker/bootstrap-datetimepicker.min.css');
			...
			$data['header'] = $this->load->controller('extension/so_entry/soconfig/quickview_header');

			$this->response->setOutput($this->load->view('extension/so_entry/soconfig/quickview', $data));
		} else {
			$url = '';
