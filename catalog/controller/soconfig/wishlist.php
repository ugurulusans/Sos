...
class Wishlist extends \Opencart\System\Engine\Controller {
	public function index() {
		...
		$this->load->language('account/wishlist','',$this->config->get('config_language'));
	...
	public function add() {
		...
		$this->load->language('extension/so_entry/soconfig/wishlist','',$this->config->get('config_language'));
		$json = array();
