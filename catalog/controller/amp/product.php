<?php
class ControllerExtensionAmpProduct extends Controller {
	private $error = array();
	...
	public function index() {
		...
		if ($product_info) {
			...
			$data['button_cart'] = $this->language->get('button_cart');
			 $data['amp_cart'] = $this->url->link('product/product', 'product_id=' . $this->request->get['product_id']).'&addcart=true';
			...
			$this->response->setOutput($this->load->view('amp/product', $data));
		} else {
			$url = '';
