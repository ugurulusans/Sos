...
final class Device extends \stdClass {
	...
	public function __construct($registry) {
		...
		if(!$this->is_admin()){
			...
			if (!defined('URL_TEMPLATE'))  define('URL_TEMPLATE', DIR_EXTENSION.'so_entry/view/template/');
		}else{
			if (!defined('URL_TEMPLATE'))  define('URL_TEMPLATE', DIR_EXTENSION.'so_entry/view/template/');
			if (!defined('DIR_TEMPLATE_FRONT')) define('DIR_TEMPLATE_FRONT', DIR_EXTENSION.'so_entry/catalog/view/template/');
		}
