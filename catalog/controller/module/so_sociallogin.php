...
class SoSociallogin extends \Opencart\System\Engine\Controller {	
	public function index() {
		...
		if (isset($setting) && $setting['so_sociallogin_enable'] && $this->config->get('so_sociallogin_enable')) {
			...
			$this->load->language('extension/so_entry/module/so_sociallogin','',$this->config->get('config_language'));
			...
			{
				return $this->load->view('extension/so_entry/module/so_sociallogin/default', $data);
		    }
		}
	}
	...
	public function FacebookLogin() {
		...
		try {
		  	$accessToken = $helper->getAccessToken($site_url.'index.php?route=extension/so_entry/module/so_sociallogin|FacebookLogin');
		} catch(Facebook\Exceptions\FacebookResponseException $e) {
		  	echo 'Graph returned an error: ' . $e->getMessage();
		  	exit;
		} catch(Facebook\Exceptions\FacebookSDKException $e) {
	...
	public function TwitterLogin() {
		...
		$request_token = $connection->getRequestToken($this->url->link('extension/so_entry/module/so_sociallogin/TwitterToken', '', 'SSL'));
	...
	public function TwitterToken() {
		...
		require_once (DIR_EXTENSION.'so_entry/system/library/so_social/twitter/twitteroauth.php');
	...
	public function LinkedinLogin() {
		...
		require_once (DIR_EXTENSION.'so_entry/system/library/so_social/linkedIn/http.php');
		require_once (DIR_EXTENSION.'so_entry/system/library/so_social/linkedIn/oauth_client.php');
		
		$client = new \oauth_client_class;
		$client->debug = false;
		$client->debug_http = true;
		$client->redirect_uri = $this->url->link('extension/so_entry/module/so_sociallogin/LinkedinLogin', '', 'SSL');
